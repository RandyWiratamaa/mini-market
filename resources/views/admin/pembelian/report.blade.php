        ...
        <div class="col s12">
            ...
            <div class="card">
                <div class="card-content">
                    ...
                    <?php if($cari == 'filter'):?>
                            <h2>Laporan Pembelian {{$carijudul}} Dari {{$data['dari']}} Ke {{$data['ke']}}</h2>
                        <?php else:?>
                            <h2>Laporan Pembelian {{$carijudul}}</h2>
                        <?php endif;?>
                        <br>
                    ...
                    <div class="control-group">
                            ...
                            <li><a href="{{route('report-beli')}}?cari=semua"><i class="i"></i> Semua</a></li>
                            <li><a href="{{route('report-beli')}}?cari=hariini"><i class="i"></i> Hari Ini</a></li>
                                <li><a href="{{route('report-beli')}}?cari=bulanini"><i class="i"></i> Bulan Ini</a></li>
                                <li><a href="{{route('report-beli')}}?cari=bulanlalu"><i class="i"></i> Bulan Lalu</a></li>
                                <li><a href="{{route('report-beli')}}?cari=tahunini"><i class="i"></i> Tahun Ini</a></li>
                        ...
                        <div class="row filtercari">
                            <form action="{{route('report-beli')}}" action="get">
                        ...
                        {{-- <a href="{{ route('pembelian.export_excel') }}" class="btn btn-success my-3" target="_blank">EXPORT EXCEL</a> --}}
...
<script type="text/javascript">
    ...
    $(document).on('keyup', '.dataTables_wrapper .dataTables_filter input', function(){
        ...
        $('.baris-data').each(function(){
            var angka = parseInt($(this).find('.tagihan').val());
            nilai += angka
        })
        konver(nilai)
    })
